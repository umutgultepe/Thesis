...
enum boneID
{
	...
	BONE_LEFT_FOOT=14,
	BONE_RIGHT_FOOT=15,
	BONE_LEG_EXTENSION_UP_L=16,
	BONE_LEG_EXTENSION_UP_R=17,
	BONE_LEG_EXTENSION_HIP_L=18,
	BONE_LEG_EXTENSION_HIP_R=19,
	BONE_LEG_EXTENSION_HIP2_L=20,
	BONE_LEG_EXTENSION_HIP2_R=21,
	BONE_LEG_EXTENSION_DUMMY_L=22,
	BONE_LEG_EXTENSION_DUMMY_R=23,
	BONE_WAIST_EXTENTION_L=24,
	BONE_WAIST_EXTENTION_R=25,
	BONE_GROIN_EXTENTION=26,
	BONE_UNKNOWN=27,
};
